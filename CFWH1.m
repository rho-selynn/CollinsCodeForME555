...
%input values below:
Nexch = 1;
ms = 55.56*0.0984; %steam mass flow rate of CFWH
Rfi = 0.00015; Rfo = 0.00013; %fouling factors
Tho = 263.943; Thi = 572.555; Tmo = 260.943 ; Tmi = 209.385; %temperature values
...
k = 0.641; v = 1.384e-7; Prw = 0.841; p = 827.05; Cpw = 4.655; u = 1.159e-4;

%Steam properties T = 263.943C @ 5MPa

hf = 1154.146; hfg = 1640.134; Prs = 0.922; pl = 185.68; Cps = 4.7; ul = 8.21e-5; kl = 0.464; 
...
dTin = Thi - Tmi;
dTout = Tho - Tmo;
Tfoi = 191.171; Tfoo = 0.681; %guesses for fouled surface at the inlet and outlet of the tube (C or K)
