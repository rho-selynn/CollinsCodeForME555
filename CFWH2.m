...
%input values below:
Nexch = 1;
ms = 55.56*0.099; %steam mass flow rate of CFWH
Rfi = 0.00015; Rfo = 0.00013; %fouling factors
Tho = 212.385; Thi = 424.974; Tmo = 209.385 ; Tmi = 148.836; %temperature values
hin = 3603.09; hout = 1154.5; %enthalpy values entering and exiting the CFWH at states 2 and 21
u_cw = 2; %velocity of cooling water (m = pAv)

%Cooling water properties T = 179.11C @ 10MPa

k = 0.678; v = 1.703e-7; Prw = 1.00; p = 893.88; Cpw = 4.362; u = 1.56e-4;

%Steam properties T = 212.371C @ 2MPa

hf = 908.6; hfg = 1890.85; Prs = 0.973; pl = 453.17; Cps = 3.481; ul = 7.56e-5; kl = 0.353; 
...
dTin = Thi - Tmi;
dTout = Tho - Tmo;
Tfoi = 114.133; Tfoo = 0.470; %guesses for fouled surface at the inlet and outlet of the tube (C or K)
